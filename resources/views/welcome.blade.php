			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						<li><a href="#"><i class="fa fa-phone"></i> +502 46334758</a></li>
                    ...
                    @if (Route::has('login'))
                       @auth
						<li><a href="{{ url('/dashboard') }}"><i class="fa fa-user-o"></i> My Account</a></li>
                        @else
						<li><a href="{{ route('login') }}"><i class="fa fa-user-o"></i> Login</a></li>
                        @if (Route::has('register'))
						<li><a href="{{ route('register') }}"><i class="fa fa-user-o"></i> Registrarse</a></li>
                        @endif
                      @endauth
