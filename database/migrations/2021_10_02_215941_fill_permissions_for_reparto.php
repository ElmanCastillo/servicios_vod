...
class FillPermissionsForReparto extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForReparto constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.reparto',
            'admin.reparto.index',
            'admin.reparto.create',
            'admin.reparto.show',
            'admin.reparto.edit',
            'admin.reparto.delete',
            'admin.reparto.bulk-delete',
        ]);
