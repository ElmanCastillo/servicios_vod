...
class FillPermissionsForSuscriptore extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSuscriptore constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.suscriptore',
            'admin.suscriptore.index',
            'admin.suscriptore.create',
            'admin.suscriptore.show',
            'admin.suscriptore.edit',
            'admin.suscriptore.delete',
            'admin.suscriptore.bulk-delete',
        ]);
