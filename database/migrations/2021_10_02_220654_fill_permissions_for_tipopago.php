...
class FillPermissionsForTipopago extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTipopago constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tipopago',
            'admin.tipopago.index',
            'admin.tipopago.create',
            'admin.tipopago.show',
            'admin.tipopago.edit',
            'admin.tipopago.delete',
            'admin.tipopago.bulk-delete',
        ]);
