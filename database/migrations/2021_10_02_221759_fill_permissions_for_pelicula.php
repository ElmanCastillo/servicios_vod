...
class FillPermissionsForPelicula extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPelicula constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.pelicula',
            'admin.pelicula.index',
            'admin.pelicula.create',
            'admin.pelicula.show',
            'admin.pelicula.edit',
            'admin.pelicula.delete',
            'admin.pelicula.bulk-delete',
        ]);
