...
class FillPermissionsForListapelicula extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForListapelicula constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.listapelicula',
            'admin.listapelicula.index',
            'admin.listapelicula.create',
            'admin.listapelicula.show',
            'admin.listapelicula.edit',
            'admin.listapelicula.delete',
            'admin.listapelicula.bulk-delete',
        ]);
